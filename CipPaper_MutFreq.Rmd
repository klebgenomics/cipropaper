...
freq_per_det_byPheno_summary <- freq_per_det_byPheno %>%
  ...
  mutate(R_test=if_else(R_OR!="Inf",paste0(round(R_OR,2), " (p=",scientific(R_pval,2), ")"), "-")) %>%
  mutate(NWT_test=if_else(NWT_OR!="Inf",paste0(round(NWT_OR,2), " (p=",scientific(NWT_pval,2), ")"), "-")) %>%
