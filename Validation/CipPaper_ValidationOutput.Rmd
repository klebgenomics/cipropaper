...
patch <- (wrap_elements(HowdenGorrie_MIC) +ggtitle("A) HowdenGorrie MIC (N=212)") + wrap_elements(MBIRA_MIC) + ggtitle("B) MBIRA MIC (N=57)")+ wrap_elements(MBIRA_DD) + ggtitle("C) MBIRA Disk Diffusion (N=96)"))
...
(wrap_elements(HowdenGorrie_dist) +ggtitle("A) HowdenGorrie (N=212) - MIC distribution vs.\n genotype profile") + wrap_elements(HowdenGorrie_profile) + ggtitle("B) HowdenGorrie (N=212) - observed phenotype vs.\n genotype profile ")+ wrap_elements(MBIRA_MIC_dist) +ggtitle("C) MBIRA (N=57) - MIC distribution vs.\n genotype profile")) /  ((wrap_elements(MBIRA_DD_dist) +ggtitle("D) MBIRA (N=96) - Disk diffusion distribution vs.\n genotype profile") + wrap_elements(MBIRA_profile) + ggtitle("E) MBIRA (N=153) - observed phenotype vs.\n genotype profile ")))
