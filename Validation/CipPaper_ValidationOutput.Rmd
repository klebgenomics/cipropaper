...
patch <- (wrap_elements(EUSCAPE_EURECA_MIC) +
            ...
            ggtitle("J) IZSAM MIC (n=161)")+
            wrap_elements(Oxfordshire_Kvv_MIC) +
            ggtitle("K) Oxfordshire* MIC (n=72)")+
...
(wrap_elements(Oxfordshire_Kvv_dist) +ggtitle("U) Oxfordshire* (n=72) - MIC distribution vs.\n genotype profile") + wrap_elements(Oxfordshire_Kvv_profile) + ggtitle("V) Oxfordshire* (n=72) - observed phenotype vs.\n genotype profile")) /
