...
TunisiaSmaoui_profile <- readPNG("SmaouiTunisia_ValidationOutput/StackedBar_PredGroup_SIR.png", native=TRUE)   
  ...
  (wrap_elements(EUSCAPE_EURECA_dist) +ggtitle("1) A (EUCAST) / \n EURECA & EUSCAPE (n=2133) - MIC distribution vs.\n genotype profile") + wrap_elements(EUSCAPE_EURECA_profile) + ggtitle("2) A (EUCAST) / \n EURECA & EUSCAPE (n=2133) - observed phenotype vs.\n genotype profile"))/
  
    (wrap_elements(IndiaGHRU_dist) +ggtitle("3) B (EUCAST) / \nIndia GHRU (n=536) - MIC distribution vs.\n genotype profile") + wrap_elements(IndiaGHRU_profile) + ggtitle("4) B (EUCAST) / \nIndia GHRU (n=536) - observed phenotype vs.\n genotype profile")) 
...
ggsave(height=13, width=11, file="../figs/FigS11_extValidation_genoprofiles_1.pdf")
  ...
  (wrap_elements(AGAR_dist) +ggtitle("5) C (EUCAST) / \n AGAR GnSOP (n=485) - MIC distribution vs.\n genotype profile") + wrap_elements(AGAR_profile) + ggtitle("6) C (EUCAST) / \n AGAR GnSOP (n=485) - observed phenotype vs.\n genotype profile")) / 
  (wrap_elements(Oxfordshire_Kpn_dist) +ggtitle("7) D (EUCAST) / \n Oxfordshire (n=295) - MIC distribution vs.\n genotype profile") + wrap_elements(Oxfordshire_Kpn_profile) + ggtitle("8) D (EUCAST) / \n Oxfordshire (n=295) - observed phenotype vs.\n genotype profile")) 
...
ggsave(height=13, width=11, file="../figs/FigS11_extValidation_genoprofiles_2.pdf")
  ...
  (wrap_elements(HRYC_Spain_dist) +ggtitle("9) E (EUCAST) / \n HURYC & CIBERINFEC (n=173) - MIC distribution vs.\n genotype profile") + wrap_elements(HRYC_Spain_profile) + ggtitle("10) E (EUCAST) \ \n HURYC & CIBERINFEC (n=173) \n - observed phenotype vs. genotype profile"))  / 
      (wrap_elements(LaPaz_Lazaro_dist) +ggtitle("11) F (EUCAST) / \n HULP (n=148) - MIC distribution vs.\n genotype profile") + wrap_elements(LaPaz_Lazaro_profile) + ggtitle("12) F (EUCAST) \ \n HULP (n=148) \n - observed phenotype vs. genotype profile")) 
...
(wrap_elements(Kayama_dist) +ggtitle("13) G (CLSI) / \n JARBS-GNR Japan (n=834) - MIC distribution vs.\n genotype profile") + wrap_elements(Kayama_profile) + ggtitle("14)  G (CLSI) / \n JARBS-GNR Japan (n=834) - observed phenotype vs.\n genotype profile")) /
  
(wrap_elements(MBIRA_Kpn_dist) +ggtitle("15) H (CLSI) / \n MBIRA (n=263) - MIC distribution vs.\n genotype profile") + wrap_elements(MBIRA_Kpn_profile) + ggtitle("16) H (CLSI) / \n MBIRA (n=263) - observed phenotype vs.\n genotype profile")) 
