...
bind_rows(lst(MBIRA_Kpn_genotype,
  ...
  mutate(N=S+I+R) %>%
  mutate(R_PPV = paste0(R,"/",(S+R), " (", round(R/(S+R)*100, 2), "%)")) %>%
  select (-c(S,I,R,N))

pooled_dataset_genotype$R_PPV[pooled_dataset_genotype$R_PPV == '0/0 (NaN%)'] <- '-'

pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '0^ QRDR, 0 PMQR, 0 aac6'] <- '0^ QRDR, 0 PMQR, 0 aac6 (R/(S+R) (PPV%), WT S prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '0 QRDR, 0 PMQR, 1 aac6'] <- '0 QRDR, 0 PMQR, 1 aac6 (R/(S+R) (PPV%), WT S prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '0 QRDR, qnrB1, 0 aac6'] <- '0 QRDR, qnrB1, 0 aac6 (R/(S+R) (PPV%), NWT I prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '1 QRDR, 0 PMQR, 0 aac6'] <- '1 QRDR, 0 PMQR, 0 aac6 (R/(S+R) (PPV%), NWT R prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '1 QRDR, 0 PMQR, 1 aac6'] <- '1 QRDR, 0 PMQR, 1 aac6 (R/(S+R) (PPV%), NWT R prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '>1 QRDR, 0 PMQR, * aac6'] <- '>1 QRDR, 0 PMQR, * aac6 (R/(S+R) (PPV%), NWT R prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '0 QRDR, 1^ PMQR, 0 aac6'] <- '0 QRDR, 1^ PMQR, 0 aac6 (R/(S+R) (PPV%), NWT R prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '0 QRDR, 1 PMQR, 1 aac6'] <- '0 QRDR, 1 PMQR, 1 aac6 (R/(S+R) (PPV%), NWT R prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '0 QRDR, >1 PMQR, * aac6'] <- '0 QRDR, >1 PMQR, * aac6 (R/(S+R) (PPV%), NWT R prediction)'
pooled_dataset_genotype$Group[pooled_dataset_genotype$Group == '>0 QRDR, >0 PMQR, * aac6'] <- '>0 QRDR, >0 PMQR, * aac6 (R/(S+R) (PPV%), NWT R prediction)'
...
pooled_dataset_genotype_wide <- pooled_dataset_genotype_wide[, c("Dataset","0^ QRDR, 0 PMQR, 0 aac6 (R/(S+R) (PPV%), WT S prediction)","0 QRDR, 0 PMQR, 1 aac6 (R/(S+R) (PPV%), WT S prediction)","0 QRDR, qnrB1, 0 aac6 (R/(S+R) (PPV%), NWT I prediction)","1 QRDR, 0 PMQR, 0 aac6 (R/(S+R) (PPV%), NWT R prediction)","1 QRDR, 0 PMQR, 1 aac6 (R/(S+R) (PPV%), NWT R prediction)",">1 QRDR, 0 PMQR, * aac6 (R/(S+R) (PPV%), NWT R prediction)","0 QRDR, 1^ PMQR, 0 aac6 (R/(S+R) (PPV%), NWT R prediction)","0 QRDR, 1 PMQR, 1 aac6 (R/(S+R) (PPV%), NWT R prediction)","0 QRDR, >1 PMQR, * aac6 (R/(S+R) (PPV%), NWT R prediction)",">0 QRDR, >0 PMQR, * aac6 (R/(S+R) (PPV%), NWT R prediction)")]
