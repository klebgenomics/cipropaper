...
patch <- (wrap_elements(HowdenGorrie_MIC) +ggtitle("A) HowdenGorrie_MIC (N=212)") + wrap_elements(MBIRA_MIC) + ggtitle("B) MBIRA (N=88)")+ wrap_elements(MBIRA_DD) + ggtitle("C) MBIRA (N=160)"))/wrap_elements(validation_plot) + ggtitle("D) Evaluation metrics")

ggsave(height=8, width=10, file="../figs/Fig7_extValidation.png")
ggsave(height=8, width=10, file="../figs/Fig7_extValidation.pdf")
