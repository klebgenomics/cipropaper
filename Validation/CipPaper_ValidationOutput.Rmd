...
(wrap_elements(EUSCAPE_EURECA_Kvv_dist) +ggtitle("xxxix) EUSCAPE/EURECA Kvv (n=41) \n - MIC distribution vs. genotype profile") + wrap_elements(EUSCAPE_EURECA_Kvv_profile) + ggtitle("xxxviii) EUSCAPE/EURECA Kvv (n=41) \n - observed phenotype vs. genotype profile"))/

(wrap_elements(Pacheco_Brazil_dist) +ggtitle("xxxix) iberoAMRica study (n=38) \n - MIC distribution vs. genotype profile") + wrap_elements(Pacheco_Brazil_profile) + ggtitle("xl) iberoAMRica study (n=38) \n - observed phenotype vs. genotype profile")) 
...
ggsave(height=13, width=11, file="../figs/FigS11_extValidation_genoprofiles_10.pdf")
  ...
  (wrap_elements(Harris_MERINO_dist) +ggtitle("xli) MERINO trial (n=36) \n - DD distribution vs. genotype profile") + wrap_elements(Harris_MERINO_dist) + ggtitle("xlii) MERINO trial (n=36) \n - observed phenotype vs. genotype profile")) 
