...
MBIRA_DD <- readPNG("MBIRA_ValidationOutput/DD_PredRIS.png", native=TRUE)

patch <- (wrap_elements(HowdenGorrie_MIC) +ggtitle("A) HowdenGorrie MIC (N=212)") + wrap_elements(MBIRA_MIC) + ggtitle("B) MBIRA MIC (N=86)")+ wrap_elements(MBIRA_DD) + ggtitle("C) MBIRA Disk Diffusion (N=159)"))

ggsave(height=5, width=10, file="../figs/Fig7_extValidation.png")
ggsave(height=5, width=10, file="../figs/Fig7_extValidation.pdf")
...
MBIRA_DD_dist <- readPNG("MBIRA_ValidationOutput/DD_PredGroup.png", native=TRUE)
MBIRA_profile <- readPNG("MBIRA_ValidationOutput/StackedBar_PredGroup_SIR.png", native=TRUE)

(wrap_elements(HowdenGorrie_dist) +ggtitle("A) HowdenGorrie (N=212) - MIC distribution vs.\n genotype profile") + wrap_elements(HowdenGorrie_profile) + ggtitle("B) HowdenGorrie (N=212) - observed phenotype vs.\n genotype profile ")+ wrap_elements(MBIRA_MIC_dist) +ggtitle("C) MBIRA (N=86) - MIC distribution vs.\n genotype profile")) /  ((wrap_elements(MBIRA_DD_dist) +ggtitle("D) MBIRA (N=159) - Disk diffusion distribution vs.\n genotype profile") + wrap_elements(MBIRA_profile) + ggtitle("E) MBIRA (N=245) - observed phenotype vs.\n genotype profile ")))
                                                                                                                                                  

ggsave(height=9, width=15, file="../figs/FigS11_extValidation_genoprofiles.png")
ggsave(height=9, width=15, file="../figs/FigS11_extValidation_genoprofiles.pdf")
