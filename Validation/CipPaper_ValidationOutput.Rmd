...
validation_summary <- rbind(MBIRA_R_prediction_summary$summary,
                            ...
                            EUSCAPE_EURECA_R_prediction_summary$summary,
...
validation_summary_table <- as_tibble(validation_summary) %>%
  mutate(Prediction=c("R", "NWT","R", "NWT","R", "NWT","R", "NWT","R", "NWT", "R", "NWT", "R", "NWT","R", "NWT"))%>%
  mutate(Dataset=c("MBIRA", "MBIRA", "HowdenGorrie", "HowdenGorrie", "AGAR", "AGAR", "MilanSanRafaelle", "MilanSanRafaelle", "HailuEthiopia", "HailuEthiopia", "KayamaJapan", "KayamaJapan", "FeaseyMalawi", "FeaseyMalawi", "EUSCAPE_EURECA", "EUSCAPE_EURECA")) %>%
...
patch <- (wrap_elements(HowdenGorrie_MIC) +
            ...
            wrap_elements(EUSCAPE_EURECA_MIC) +
            ggtitle("H) EUSCAPE & EURECA MIC (N=2133)")  
          )+
  plot_layout(ncol = 3)

ggsave(height=10, width=13, file="../figs/Fig7_extValidation.png")
ggsave(height=10, width=13, file="../figs/Fig7_extValidation.pdf")
...
(wrap_elements(Kayama_dist) +ggtitle("K) Kayama Japan (N=834) - MIC distribution vs.\n genotype profile") + wrap_elements(Kayama_profile) + ggtitle("L) Kayama Japan (N=834) - observed phenotype vs.\n genotype profile")) /
  ...
  (wrap_elements(EUSCAPE_EURECA_dist) +ggtitle("O) EURECA & EUSCAPE (N=2133) - MIC distribution vs.\n genotype profile") + wrap_elements(EUSCAPE_EURECA_profile) + ggtitle("P) EURECA & EUSCAPE (N=2133) - observed phenotype vs.\n genotype profile"))                                                                                                                                  
