...
patch <- (wrap_elements(HowdenGorrie_MIC) +ggtitle("A) HowdenGorrie MIC (N=212)") + wrap_elements(MBIRA_MIC) + ggtitle("B) MBIRA MIC (N=88)")+ wrap_elements(MBIRA_DD) + ggtitle("C) MBIRA Disk Diffusion (N=160)"))/wrap_elements(validation_plot) + ggtitle("D) Evaluation metrics")
