...
validation_summary_table <- as_tibble(validation_summary) %>%
  mutate(Prediction=c("R", "NWT","R", "NWT","R", "NWT","R", "NWT","R", "NWT", "R", "NWT", "R", "NWT","R", "NWT","R", "NWT","R", "NWT","R", "NWT","R", "NWT","R", "NWT","R", "NWT","R", "NWT","R", "NWT"))%>%
  mutate(Dataset=c("EUSCAPE & EURECA", "EUSCAPE & EURECA","JARBS-GNR", "JARBS-GNR", "India GHRU", "India GHRU", "AGAR GnSOP", "AGAR GnSOP","Oxfordshire","Oxfordshire", "MBIRA", "MBIRA", "Controlling Superbugs study & Victorian CPE program", "Controlling Superbugs study & Victorian CPE program",  "IRCCS Ospedale San Raffaele", "IRCCS Ospedale San Raffaele",  "HURYC & CIBERINFEC", "HURYC & CIBERINFEC","IZSAM","IZSAM","Oxfordshire*","Oxfordshire*", "SCHARKI", "SCHARKI", "Queen Elizabeth Central Hospital", "Queen Elizabeth Central Hospital","University of Zurich", "University of Zurich", "Addis Ababa University*", "Addis Ababa University*", "CHAMPS", "CHAMPS")) %>%
    mutate(Country=c("Various European countries", "Various European countries","Japan", "Japan", "India", "India", "Australia", "Australia","United Kingdom","United Kingdom","Tanzania, Ethiopia, Malawi, Zambia, Ghana, Nigeria, South Africa", "Tanzania, Ethiopia, Malawi, Zambia, Ghana, Nigeria, South Africa", "Australia", "Australia",  "Italy", "Italy",  "Spain", "Spain","Italy","Italy","United Kingdom", "United Kingdom", "Germany", "Germany", "Malawi", "Malawi","Switzerland", "Switzerland", "Ethiopia", "Ethiopia", "South Africa", "South Africa")) %>%
...
patch <- (wrap_elements(EUSCAPE_EURECA_MIC) +
            ...
            ggtitle("E) Oxfordshire MIC (n=341)") +            
            wrap_elements(MBIRA_MIC) + 
            ggtitle("F) MBIRA MIC (n=228)")+             
            wrap_elements(HowdenGorrie_MIC) +
            ggtitle("G) Controlling Superbugs study & \nVictorian CPE program MIC (n=212)") +
            wrap_elements(Milan_MIC) +
            ggtitle("H) IRCCS Ospedale San Raffaele MIC (n=198)")+
            wrap_elements(HRYC_Spain_MIC) +
            ggtitle("I) HURYC & CIBERINFEC MIC (n=173)")+
            wrap_elements(IZSAM_Italy_MIC) +
            ggtitle("J) HURYC & CIBERINFEC MIC (n=161)")+
            wrap_elements(Oxfordshire_Kvv_MIC) +
            ggtitle("K) Oxfordshire* MIC (n=71)")+
            wrap_elements(NeumannGermany_MIC) +
            ggtitle("L) SCHARKI MIC (n=56)")+  
            wrap_elements(FeaseyMalawi_DD) +
            ggtitle("M) Queen Elizabeth Central Hospital \n(Malawi) DD (n=737)") +
            wrap_elements(EgliSwitzerland_DD) +
            ggtitle("N) University of Zurich DD (n=72)")+
            wrap_elements(HailuEthiopia_DD) +
            ggtitle("O) Addis Ababa University* \n(Ethiopia) DD (n=70)")+
            wrap_elements(Whitelaw_CHAMPS_DD) +
            ggtitle("P) CHAMPS DD (n=40)")
          )+
  plot_layout(ncol = 3)
...
MBIRA_dist <- readPNG("MBIRA_ValidationOutput/MIC_PredGroup.png", native=TRUE)
MBIRA_profile <- readPNG("MBIRA_ValidationOutput/StackedBar_PredGroup_SIR.png", native=TRUE)
...
(wrap_elements(Oxfordshire_Kpn_dist) +ggtitle("I) Oxfordshire (n=341) - MIC distribution vs.\n genotype profile") + wrap_elements(Oxfordshire_Kpn_profile) + ggtitle("J) Oxfordshire (n=341) - observed phenotype vs.\n genotype profile")) /

(wrap_elements(MBIRA_dist) +ggtitle("K) MBIRA (n=228) - MIC distribution vs.\n genotype profile") + wrap_elements(MBIRA_profile) + ggtitle("K) MBIRA (n=228) - observed phenotype vs.\n genotype profile")) /
  
(wrap_elements(HowdenGorrie_dist) +ggtitle("M) Controlling Superbugs study & \nVictorian CPE program (n=212) - MIC distribution vs.\n genotype profile") + wrap_elements(HowdenGorrie_profile) + ggtitle("N) Controlling Superbugs study & \nVictorian CPE program (n=212) - observed phenotype vs.\n genotype profile")) /
  
(wrap_elements(Milan_dist) +ggtitle("O) IRCCS Ospedale San Raffaele (n=198) - MIC distribution vs.\n genotype profile") + wrap_elements(Milan_profile) + ggtitle("P) IRCCS Ospedale San Raffaele (n=198) \n - observed phenotype vs. genotype profile"))
...
ggsave(height=13, width=10, file="../figs/FigS11_extValidation_genoprofiles_2.pdf")
  ...
  (wrap_elements(HRYC_Spain_dist) +ggtitle("Q) HURYC & CIBERINFEC (n=173) - MIC distribution vs.\n genotype profile") + wrap_elements(HRYC_Spain_profile) + ggtitle("R) HURYC & CIBERINFEC (n=173) \n - observed phenotype vs. genotype profile")) /

(wrap_elements(IZSAM_Italy_dist) +ggtitle("S) IZSAM (n=161) - MIC distribution vs.\n genotype profile") + wrap_elements(IZSAM_Italy_profile) + ggtitle("T) IZSAM (n=161) - observed phenotype vs.\n genotype profile")) /
  
(wrap_elements(Oxfordshire_Kvv_dist) +ggtitle("U) Oxfordshire* (n=71) - MIC distribution vs.\n genotype profile") + wrap_elements(Oxfordshire_Kvv_profile) + ggtitle("V) Oxfordshire* (n=71) - observed phenotype vs.\n genotype profile")) /

(wrap_elements(NeumannGermany_dist) +ggtitle("W) SCHARKI (n=56) - MIC distribution vs.\n genotype profile") + wrap_elements(NeumannGermany_profile) + ggtitle("X) SCHARKI (n=56) - observed phenotype vs.\n genotype profile")) 
...
(wrap_elements(Feasey_dist) +ggtitle("Y) Queen Elizabeth Central Hospital Malawi (n=737) \n - DD distribution vs. genotype profile") + wrap_elements(Feasey_profile) + ggtitle("Z) Queen Elizabeth Central Hospital Malawi (n=737) \n - observed phenotype vs. genotype profile")) /
  
  (wrap_elements(EgliSwitzerland_dist) +ggtitle("AA) University of Zurich (n=72) - DD distribution vs.\n genotype profile") + wrap_elements(EgliSwitzerland_profile) + ggtitle("BB) University of Zurich (n=72) - observed phenotype vs.\n genotype profile")) /

(wrap_elements(Hailu_dist) +ggtitle("CC) Addis Ababa University* (n=70) - DD distribution vs.\n genotype profile") + wrap_elements(Hailu_profile) + ggtitle("DD) Addis Ababa University* (n=70) - observed phenotype vs.\n genotype profile")) /

(wrap_elements(WhitelawCHAMPS_dist) +ggtitle("EE) CHAMPS (n=40) - DD distribution vs.\n genotype profile") + wrap_elements(WhitelawCHAMPS_profile) + ggtitle("FF) CHAMPS (n=40) - observed phenotype vs.\n genotype profile")) 
