...
```{r EUSCAPE_EURECA_Kpn}

EUSCAPE_EURECA_Kpn_SI <- EUSCAPE_EURECA_Kpn %>% 
  rename(Group=...1) %>% 
  filter(Group=="pred_S" | Group=="pred_I") %>%
  rowwise()%>%
  mutate(S_I = sum(S, I)) %>%
...
EUSCAPE_EURECA_Kpn_R <- EUSCAPE_EURECA_Kpn %>% 
  rename(Group=...1) %>% 
  filter(Group=="pred_R" | Group=="pred_I") %>%
  rowwise()%>%
  mutate(S_I = sum(S, I)) %>%
...
EUSCAPE_EURECA_Kpn_SIR <- rbind(EUSCAPE_EURECA_Kpn_SI, EUSCAPE_EURECA_Kpn_R) %>% distinct()

subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_S_I")$S_I
table(EUSCAPE_EURECA_Kpn_SIR$S_I)

EUSCAPE_EURECA_Kpn_R_prediction <- matrix(c(subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_S_I")$S_I, 
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_S_I")$R,
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_R")$S_I,
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_R")$R), ncol=2, byrow=TRUE)

colnames(EUSCAPE_EURECA_Kpn_R_prediction) <- c('S_I','R')
rownames(EUSCAPE_EURECA_Kpn_R_prediction) <- c('pred_S_I','pred_R')
EUSCAPE_EURECA_Kpn_R_prediction_summary<-metrics(EUSCAPE_EURECA_Kpn_R_prediction)

EUSCAPE_EURECA_Kpn_NWT_prediction <- matrix(c(subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_S")$S, 
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_S")$I_R,
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_I_R")$S,
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_I_R")$I_R), ncol=2, byrow=TRUE)
colnames(EUSCAPE_EURECA_Kpn_NWT_prediction) <- c('S','I_R')
rownames(EUSCAPE_EURECA_Kpn_NWT_prediction) <- c('pred_S','pred_I_R')
EUSCAPE_EURECA_Kpn_NWT_prediction_summary<-metrics(EUSCAPE_EURECA_Kpn_NWT_prediction)
```

```{r EUSCAPE_EURECA_Kvv}

EUSCAPE_EURECA_Kvv_SI <- EUSCAPE_EURECA_Kvv %>% 
  rename(Group=...1) %>% 
  filter(Group=="pred_S" | Group=="pred_I") %>%
  rowwise()%>%
  mutate(S_I = sum(S, I)) %>%
...
EUSCAPE_EURECA_Kvv_R <- EUSCAPE_EURECA_Kvv %>% 
  rename(Group=...1) %>% 
  filter(Group=="pred_R" | Group=="pred_I") %>%
  rowwise()%>%
  mutate(S_I = sum(S, I)) %>%
...
EUSCAPE_EURECA_Kvv_SIR <- rbind(EUSCAPE_EURECA_Kvv_SI, EUSCAPE_EURECA_Kvv_R) %>% distinct()

subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_S_I")$S_I
table(EUSCAPE_EURECA_Kvv_SIR$S_I)

EUSCAPE_EURECA_Kvv_R_prediction <- matrix(c(subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_S_I")$S_I, 
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_S_I")$R,
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_R")$S_I,
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_R")$R), ncol=2, byrow=TRUE)

colnames(EUSCAPE_EURECA_Kvv_R_prediction) <- c('S_I','R')
rownames(EUSCAPE_EURECA_Kvv_R_prediction) <- c('pred_S_I','pred_R')
EUSCAPE_EURECA_Kvv_R_prediction_summary<-metrics(EUSCAPE_EURECA_Kvv_R_prediction)

EUSCAPE_EURECA_Kvv_NWT_prediction <- matrix(c(subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_S")$S, 
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_S")$I_R,
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_I_R")$S,
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_I_R")$I_R), ncol=2, byrow=TRUE)
colnames(EUSCAPE_EURECA_Kvv_NWT_prediction) <- c('S','I_R')
rownames(EUSCAPE_EURECA_Kvv_NWT_prediction) <- c('pred_S','pred_I_R')
EUSCAPE_EURECA_Kvv_NWT_prediction_summary<-metrics(EUSCAPE_EURECA_Kvv_NWT_prediction)
```
...
SmaouiTunisia_SI <- SmaouiTunisia %>% 
  rename(Group=...1) %>% 
  filter(Group=="pred_S" | Group=="pred_I") %>%
  rowwise()%>%
  mutate(S_I = sum(S, I)) %>%
...
SmaouiTunisia_SIR <- rbind(SmaouiTunisia_SI, SmaouiTunisia_R) %>% distinct()

subset(SmaouiTunisia_SIR, Group == "pred_S_I")$S_I
table(SmaouiTunisia_SIR$S_I)

SmaouiTunisia_R_prediction <- matrix(c(subset(SmaouiTunisia_SIR, Group == "pred_S_I")$S_I, 
                subset(SmaouiTunisia_SIR, Group == "pred_S_I")$R,
                subset(SmaouiTunisia_SIR, Group == "pred_R")$S_I,
                subset(SmaouiTunisia_SIR, Group == "pred_R")$R), ncol=2, byrow=TRUE)

colnames(SmaouiTunisia_R_prediction) <- c('S_I','R')
rownames(SmaouiTunisia_R_prediction) <- c('pred_S_I','pred_R')
SmaouiTunisia_R_prediction_summary<-metrics(SmaouiTunisia_R_prediction)

SmaouiTunisia_NWT_prediction <- matrix(c(subset(SmaouiTunisia_SIR, Group == "pred_S")$S, 
                subset(SmaouiTunisia_SIR, Group == "pred_S")$I_R,
                subset(SmaouiTunisia_SIR, Group == "pred_I_R")$S,
                subset(SmaouiTunisia_SIR, Group == "pred_I_R")$I_R), ncol=2, byrow=TRUE)
colnames(SmaouiTunisia_NWT_prediction) <- c('S','I_R')
rownames(SmaouiTunisia_NWT_prediction) <- c('pred_S','pred_I_R')
SmaouiTunisia_NWT_prediction_summary<-metrics(SmaouiTunisia_NWT_prediction)
```
...
bind_rows(MBIRA_Kpn_SIR,
          ...
          KayamaJapan_SIR,
          FeaseyMalawi_SIR, 
          EUSCAPE_EURECA_Kpn_SIR,
          EUSCAPE_EURECA_Kvv_SIR,
          EgliSwitzerland_SIR,
          HRYC_Spain_SIR,
          IndiaGHRU_SIR,
          NeumannGermany_SIR,
...
```{r}
SIR_counts_table <- bind_rows(lst(MBIRA_Kpn_SIR,
          MBIRA_Kvv_SIR, 
          HowdenGorrie_SIR,
          AGAR_SIR,
          Milan_SIR,
...
```{r combineR_NWT}
validation_summary <- rbind(EUSCAPE_EURECA_Kpn_R_prediction_summary$summary,
                            EUSCAPE_EURECA_Kpn_NWT_prediction_summary$summary,
                            ...
                            EUSCAPE_EURECA_Kvv_R_prediction_summary$summary,
                            EUSCAPE_EURECA_Kvv_R_prediction_summary$summary,
                            ...
                            SmaouiTunisia_R_prediction_summary$summary, 
                            SmaouiTunisia_NWT_prediction_summary$summary,                            
...
```{r EUSCAPE_EURECA_Kpn_excludeI}

EUSCAPE_EURECA_Kpn_excludeI_prediction <- matrix(c(subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_S_I")$S, 
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_S_I")$R,
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_R")$S,
                subset(EUSCAPE_EURECA_Kpn_SIR, Group == "pred_R")$R), ncol=2, byrow=TRUE)

colnames(EUSCAPE_EURECA_Kpn_excludeI_prediction) <- c('S','R')
rownames(EUSCAPE_EURECA_Kpn_excludeI_prediction) <- c('pred_S_I','pred_R')

EUSCAPE_EURECA_Kpn_excludeI_prediction_summary<-metrics(EUSCAPE_EURECA_Kpn_excludeI_prediction)
```

```{r EUSCAPE_EURECA_Kvv_excludeI}

EUSCAPE_EURECA_Kvv_excludeI_prediction <- matrix(c(subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_S_I")$S, 
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_S_I")$R,
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_R")$S,
                subset(EUSCAPE_EURECA_Kvv_SIR, Group == "pred_R")$R), ncol=2, byrow=TRUE)

colnames(EUSCAPE_EURECA_Kvv_excludeI_prediction) <- c('S','R')
rownames(EUSCAPE_EURECA_Kvv_excludeI_prediction) <- c('pred_S_I','pred_R')

EUSCAPE_EURECA_Kvv_excludeI_prediction_summary<-metrics(EUSCAPE_EURECA_Kvv_excludeI_prediction)
```
...
```{r SmaouiTunisia_excludeI}
SmaouiTunisia_excludeI_prediction <- matrix(c(subset(SmaouiTunisia_SIR, Group == "pred_S_I")$S, 
                subset(SmaouiTunisia_SIR, Group == "pred_S_I")$R,
                subset(SmaouiTunisia_SIR, Group == "pred_R")$S,
                subset(SmaouiTunisia_SIR, Group == "pred_R")$R), ncol=2, byrow=TRUE)

colnames(SmaouiTunisia_excludeI_prediction) <- c('S','R')
rownames(SmaouiTunisia_excludeI_prediction) <- c('pred_S_I','pred_R')

SmaouiTunisia_excludeI_prediction_summary<-metrics(SmaouiTunisia_excludeI_prediction)
...
validation_summary <- rbind(
                            EUSCAPE_EURECA_Kpn_excludeI_prediction_summary$summary,
                          ...
                          EUSCAPE_EURECA_Kvv_excludeI_prediction_summary$summary,
                          ...
                          HarrisMERINO_excludeI_prediction_summary$summary,
                           ...
                           SmaouiTunisia_excludeI_prediction_summary$summary,
...
validation_summary_table_excludeI <- as_tibble(validation_summary) %>% 
  mutate(Prediction=c("R_excludeI", "R_excludeI","R_excludeI", "R_excludeI","R_excludeI", "R_excludeI","R_excludeI", "R_excludeI","R_excludeI", "R_excludeI", "R_excludeI", "R_excludeI", "R_excludeI", "R_excludeI","R_excludeI", "R_excludeI","R_excludeI", "R_excludeI", "R_excludeI","R_excludeI", "R_excludeI", "R_excludeI","R_excludeI"))%>%
  mutate(Dataset=c("EUSCAPE & EURECA","JARBS-GNR", "India GHRU", "AGAR GnSOP","Oxfordshire","IZSAM", "MBIRA", "Controlling Superbugs study & Victorian CPE program", "IRCCS Ospedale San Raffaele", "HURYC & CIBERINFEC", "HULP", "MBIRA*","Oxfordshire*", "SCHARKI","EUSCAPE & EURECA*", "PachecoBrazil","HarrisMERINO", "Queen Elizabeth Central Hospital","SmaouiTunisia*", "University of Zurich", "Addis Ababa University*", "CHAMPS", "Pooled")) %>%
    mutate(Country=c("Various European countries","Japan", "India", "Australia","United Kingdom","Italy","Tanzania, Ethiopia, Malawi, Zambia, Ghana, Nigeria, South Africa", "Australia", "Italy","Spain, Portugal", "Spain", "Ethiopia, South Africa, Tanzania" ,"United Kingdom", "Germany","Various European countries", "Brazil", "Various countries", "Malawi","Tunisia", "Switzerland", "Ethiopia", "South Africa", "")) %>%
    rename(Sensitivity=sens, Specificity=spec, `ME`=me, `VME`=vme, `Categorical agreement`=cat, `%R`=perc_R, N=n) %>%
  mutate(Sensitivity=paste0(round(as.numeric(Sensitivity)*100,2),"%")) %>%
  mutate(Specificity=paste0(round(as.numeric(Specificity)*100,2),"%")) %>%
  mutate(ME=paste0(round(as.numeric(ME)*100,2),"%")) %>%
...
colSums(SIR_table[,-1])
validation_summary_table_total$Dataset_label[validation_summary_table_total$Dataset_label == 'All datasets combined (S=NA, R=NA)'] <- "All datasets combined (S=1757, R=4610)"
...
validation_summary_table_total$Dataset_label <- factor(as.character(validation_summary_table_total$Dataset_label), levels = c(
  "A (EUCAST, Various) (S=291, R=1687)", 
  "B (EUCAST, V) (S=84, R=441)",
  "C (EUCAST, V/P) (S=168, R=255)", 
  "D (EUCAST, P) (S=242, R=37)", 
  "E (EUCAST, S/M) (S=20, R=146)", 
  "F (EUCAST, MW/E) (S=11, R=136)", 
  "G (CLSI, MW) (S=222, R=449)",
  "H (CLSI, V/E) (S=109, R=128)", 
  "I (CLSI, V/S) (S=18, R=153)", 
  "J* (EUCAST/BSAC) (S=196, R=411)", 
  "K* (EUCAST) (S=62, R=146)", 
  "L* (Kvv, CLSI) (S=37, R=28)",
  "M* (EUCAST) (S=11, R=53)", 
  "N* (CLSI) (S=18, R=21)", 
  "IZSAM (S=7, R=273)",  
  "IRCCS Ospedale San Raffaele (S=9, R=187)", 
  "MBIRA (Kvv, CLSI) (S=85, R=5)",  
  "Oxfordshire (Kvv, EUCAST) (S=64, R=0)", 
  "SCHARKI (S=51, R=2)",
  "EUSCAPE & EURECA (Kvv, EUCAST) (S=35, R=3)", 
  "PachecoBrazil (S=10, R=28)", 
  "HarrisMERINO (S=7, R=21)", 
  "Overall median (datasets A-N)", 
  "All datasets combined (S=1757, R=4610)"))
