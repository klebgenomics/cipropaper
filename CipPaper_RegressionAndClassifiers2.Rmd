...
## FIGURE - MIC distribution - classifier profiles
...
ggsave(width=5, height=7, file="figs/FigX_MICdist_byProfile.pdf")
ggsave(width=5, height=7, file="figs/FigX_MICdist_byProfile.png")
