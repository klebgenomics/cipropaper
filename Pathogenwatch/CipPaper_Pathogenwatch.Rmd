...
#Pathogenwatch data downloaded Feb 3, 2025
...
pathogenwatch <- bind_rows(Kp %>% select(Flq_acquired, Flq_mutations, AGly_acquired, year, Country, ST, species, Study.accession, LIN.code),
                Ka %>% select(Flq_acquired, Flq_mutations, AGly_acquired, year, Country, ST, species, Study.accession, LIN.code),
                Kqv %>% select(Flq_acquired, Flq_mutations, AGly_acquired, year, Country, ST, species, Study.accession, LIN.code),
                Kv %>% select(Flq_acquired, Flq_mutations, AGly_acquired, year, Country, ST, species, Study.accession, LIN.code),
                Kqp %>% select(Flq_acquired, Flq_mutations, AGly_acquired, year, Country, ST, species, Study.accession, LIN.code))
...
PW_dat_variant_kp$variant[PW_dat_variant_kp$variant == 'aac6'] <- 'aac(6`)-Ib-cr'
...
# order of variants
variant_order_kp <- c('aac(6`)-Ib-cr', 
...
ggsave(height=9, width=7, file="../figs/FigureS12_PW_geneSTheatmapKp.png")

ggsave(height=9, width=7, file="../figs/FigureS12_PW_geneSTheatmapKp.pdf")
...
# order of variants
variant_order_nkp <- c('aac(6`)-Ib-cr', 
