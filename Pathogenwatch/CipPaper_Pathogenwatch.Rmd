...
# remove redundancy by study accession, country, year, LIN.code

PW_lin<-PW[!duplicated(PW[,c('Study.accession','Country', 'year', 'LIN.code' )]),]

PW_lin_rules<-PW[!duplicated(PW[,c('Study.accession','Country', 'year', 'LIN.code','rules_category' )]),]

PW_lin_num<-PW[!duplicated(PW[,c('Study.accession','Country', 'year', 'LIN.code','aac6', 'QRDR_mutations','acquired_genes' )]),]

PW_lin_mut<-PW[!duplicated(PW[,c('Study.accession','Country', 'year', 'LIN.code','aac6', 'Flq_mutations','Flq_acquired' )]),]
...
ggsave(height=9, width=7, file="PW_geneSTheatmapNonKp.png")

ggsave(height=9, width=7, file="PW_geneSTheatmapNonKp.pdf")
