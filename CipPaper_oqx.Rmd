...
#Table S9
```{r}
# Table S9- Contribution of solo truncations/mutations
...
write.table(oqxAB_operon_truncation_solo, "tables/TableS9_oqxAB_contribution_PPV.tsv", row.names=FALSE, sep="\t")
```
