...
#Table S8
```{r}
# Table S8- Contribution of solo truncations/mutations
...
write.table(oqxAB_operon_truncation_solo, "tables/TableS8_oqxAB_contribution_PPV.tsv", row.names=FALSE, sep="\t")
```
