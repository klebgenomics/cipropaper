...
#write.table(oqxAB_operon_truncation_solo, "oqx_solo_contribution_PPV.tsv", row.names=FALSE, sep="\t")
```
...
#write.table(oqxR_mutations_solo, "oqxR_mutations_solo_PPV.tsv", row.names=FALSE, sep="\t")
...
oqx_truncation_MIC <- cipro_antibiogram %>% 
  ...
  upset(
      intersect=c("oqxR_truncation","norB_truncation", "rarA_truncation", "rob_truncation", "hypo_truncation", "oqxR_D95E", "oqxR_V113I"), # counts are converted to binary
